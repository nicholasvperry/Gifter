...
namespace Gifter.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        //post/GetPostByIdWithComments/(id)
        ...
        //post/hottest?since=(since)
        //you do not have to name the methods called the same as the HTTPGet (hottest)
        [HttpGet("hottest")]
